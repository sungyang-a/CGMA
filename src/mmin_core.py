#-*- coding: utf-8 -*-
"""MMIN-core: a faithful re-implementation of MMIN's core mechanisms under the shared backbone (Table 4).

Re-implements the three core components of MMIN (Missing Modality Imagination
Network) on the same BiLSTM + masked-mean backbone used by the other methods,
under the same 7:1:2 split, independent test set, and depressed-class F1 metric:
  1. imagination of the missing modality's joint representation via a cascade
     residual autoencoder;
  2. a teacher-student imagination loss aligning incomplete-input representations
     to complete-input ones;
  3. a cycle-consistency loss.
This is a mechanism-level re-implementation under a shared backbone, not a full
