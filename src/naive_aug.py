#-*- coding: utf-8 -*-
"""Naive fusion + full-spectrum missing-aware augmentation (Naive + Aug; Tables 1, 2, 4).

Same attention-fusion architecture as naive_fusion.py, but trained with the
full-spectrum augmentation schedule (intact / whole-modality / frame-level,
sampled per mini-batch) and no completeness gating or supervision. Isolates the
effect of augmentation from that of gating.
